              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    // The failure used to go nowhere: no catch, so a delete the
                    // server rejected left the shop sitting in the list with no
                    // explanation at all. Report it the same way the rest of
                    // this page reports errors.
                    setError(null);
                    ...
                    try {
                      ...
                      setError(
                        `Could not delete "${shop.name}": ${err instanceof Error ? err.message : "the server rejected the request"}`,
                      );
                    } finally {
                      setDeletingShopId(null);
                    }
                  }}
                  className="flex-1 bg-red-50 hover:bg-red-100 disabled:opacity-50 text-red-600 font-bold text-xs py-2 rounded flex items-center justify-center gap-1"
                >
