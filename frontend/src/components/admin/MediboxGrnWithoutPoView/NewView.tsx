...
import { RequisitionItemRow } from "../../../types";
...
import { GrnItemDraft, PAYMENT_TYPES, batchMissingFor } from "./types";
              ...
              <tr key={it.productId} className="odd:bg-white even:bg-slate-50 hover:bg-slate-100">
                ...
                <td className="py-2 px-2 border border-slate-200 whitespace-nowrap">
                  <input
                    ...
                    placeholder="Batch No*"
                    className={`w-24 border rounded px-1.5 py-1 ${batchMissing(it) ? "border-red-400" : "border-slate-300"}`}
                  />
                </td>
                <td className="py-2 px-2 border border-slate-200 whitespace-nowrap">
                  <input
