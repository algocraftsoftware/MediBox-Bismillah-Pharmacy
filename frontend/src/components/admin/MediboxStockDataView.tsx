...
import { StockDataRow, StockDataType } from "../../types";
...
export const MediboxStockDataView: React.FC = () => {
          ...
          <tbody className="font-medium whitespace-nowrap">
            {rows.map((r, i) => (
              <tr key={`${r.itemNo}-${i}`} className="odd:bg-white even:bg-slate-50 hover:bg-emerald-50/50">
                ...
                <td className="py-3.5 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{r.itemName}</td>
                <td className="py-3.5 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.genericName}</td>
                <td className="py-3.5 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.displayCategory}</td>
                ...
                <td className="py-3.5 px-3 border border-slate-200 text-slate-500 whitespace-nowrap">{r.lastSoldDate ? r.lastSoldDate.split("T")[0] : "—"}</td>
                <td className="py-3.5 px-3 border border-slate-200 text-right whitespace-nowrap">{r.purchasePrice?.toFixed(2) ?? "—"}</td>
                <td className="py-3.5 px-3 border border-slate-200 text-right whitespace-nowrap">{r.salesPrice?.toFixed(2) ?? "—"}</td>
                <td className="py-3.5 px-3 border border-slate-200 text-right whitespace-nowrap">{r.boxQty}</td>
                <td
