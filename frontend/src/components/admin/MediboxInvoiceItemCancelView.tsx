...
export const MediboxInvoiceItemCancelView: React.FC = () => {
          ...
          <table className="w-full text-left border-collapse text-sm border border-slate-300">
            <thead>
              <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
                ...
                <th className="py-4 px-3 border border-slate-300 w-[8%] whitespace-nowrap">Barcode</th>
                <th className="py-4 px-3 border border-slate-300 w-[8%] whitespace-nowrap">Item No</th>
                <th className="py-4 px-3 border border-slate-300 w-[14%] whitespace-nowrap">Item Name</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[8%] whitespace-nowrap">Sales Price</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Bill Qty</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[9%] whitespace-nowrap">Returned Qty</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[9%] whitespace-nowrap">Remaining Qty</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[9%] whitespace-nowrap">Total Amount</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[5%] whitespace-nowrap">VAT</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Dis.Amt</th>
                <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Item Qty</th>
              ...
              {sale.items.map((it, idx) => {
                ...
                return (
                  <tr key={it.id} className="odd:bg-white even:bg-slate-50 hover:bg-slate-100">
                    ...
                    <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{it.batch?.barcode || ""}</td>
                    <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{it.product?.externalCode || ""}</td>
                    <td className="py-4 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{it.productNameSnapshot}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{fmt(it.mrp)}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{it.qty}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right text-amber-700 font-bold whitespace-nowrap">{it.canceledQty || 0}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right font-bold whitespace-nowrap">{remaining}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{fmt(it.mrp * it.qty)}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{fmt(it.vatAmt)}</td>
                    <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{fmt(it.discAmt)}</td>
