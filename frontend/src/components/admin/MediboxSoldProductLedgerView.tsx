...
import { CustomerType, SoldLedgerRow } from "../../types";
...
export const MediboxSoldProductLedgerView: React.FC = () => {
        ...
        <table className="w-full text-left border-collapse text-sm border border-slate-300">
          <thead>
            <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
              <th className="py-4 px-3 border border-slate-300 w-[4%] whitespace-nowrap">Store</th>
              ...
              <th className="py-4 px-3 border border-slate-300 w-[7%] whitespace-nowrap">Customer Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Contact No</th>
              <th className="py-4 px-3 border border-slate-300 w-[7%] whitespace-nowrap">Customer Type</th>
              ...
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Batch No</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">Qty</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">MRP</th>
              ...
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Company</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">GRN No</th>
              <th className="py-4 px-3 border border-slate-300 w-[10%] whitespace-nowrap">Company Invoice No</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Served By</th>
            </tr>
          </thead>
          <tbody className="font-medium whitespace-nowrap">
            {rows.map((r, i) => (
              <tr key={`${r.invoiceNo}-${r.batchNo}-${i}`} className="odd:bg-white even:bg-slate-50 hover:bg-emerald-50/50">
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.store}</td>
                <td className="py-4 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{r.invoiceNo}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{new Date(r.invoiceDate).toLocaleString()}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.customerId || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.customerName || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.contactNo || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.custType || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.eidPfNo || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{r.itemName}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.batchNo}</td>
                <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{r.qty}</td>
                <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{r.mrp.toFixed(2)}</td>
                <td className="py-4 px-3 border border-slate-200 text-right font-bold text-slate-900 whitespace-nowrap">{r.totalValue.toFixed(2)}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.remarks || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.company || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.grnNo || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.companyInvoiceNo || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.servedBy}</td>
              </tr>
            ))}
            {rows.length === 0 && (
              <tr>
