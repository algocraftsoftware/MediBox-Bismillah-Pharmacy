        ...
        <table className="w-full text-left border-collapse text-sm border border-slate-300">
          <thead>
            <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
              ...
              <th className="py-4 px-3 border border-slate-300 w-[7%] whitespace-nowrap">Generic Name</th>
              ...
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">Con(Pcs)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">Con(pack)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Item Qty(Box)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Item Qty(Pcs)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">PP/Pcs</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Total Values</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">MRP/Pcs</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">GP</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">GP%</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Remark</th>
      ...
      <div className="bg-white border-t border-slate-300 p-3 shrink-0 text-xs flex items-start gap-4">
        ...
        <div className="flex flex-col justify-end gap-1.5 shrink-0">
          ...
          <UnapproveButton
            ...
            label={`Requisition ${requisitionNo}`}
            onUnapprove={() => api.unapproveRequisition(id!)}
            onDone={(result) => {
              const r = result as PurchaseRequisition;
              setStatus(r.status);
              setApprovedByName(null);
              setApprovedAt(null);
              setNotice("Un-approved — this requisition is editable again.");
            }}
