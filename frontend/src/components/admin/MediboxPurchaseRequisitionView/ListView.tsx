        ...
        <table className="w-full text-left border-collapse text-sm border border-slate-300">
          <thead>
            <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
              <th className="py-4 px-3 border border-slate-300 w-[15%] whitespace-nowrap">Requisition No.</th>
              <th className="py-4 px-3 border border-slate-300 w-[11%] whitespace-nowrap">Date &amp; Time</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Store</th>
              <th className="py-4 px-3 border border-slate-300 w-[8%] whitespace-nowrap">Supplier</th>
              <th className="py-4 px-3 border border-slate-300 w-[4%] whitespace-nowrap">Mode</th>
              <th className="py-4 px-3 border border-slate-300 w-[4%] whitespace-nowrap">Type</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Status</th>
              <th className="py-4 px-3 border border-slate-300 w-[11%] whitespace-nowrap">Approved By</th>
              <th className="py-4 px-3 border border-slate-300 w-[12%] whitespace-nowrap">Approved Date</th>
              <th className="py-4 px-3 border border-slate-300 w-[4%] whitespace-nowrap">User</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">GP%</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[12%] whitespace-nowrap">Total Amount</th>
              <th className="py-4 px-3 border border-slate-300 text-center w-[4%] whitespace-nowrap">Edit</th>
            </tr>
          </thead>
          <tbody className="font-medium whitespace-nowrap">
            {rows.map((r) => (
              <tr key={r.id} className="odd:bg-white even:bg-slate-50 hover:bg-emerald-50/50">
                <td className="py-4 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{r.requisitionNo}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">
                ...
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.mode === "PHARMA" ? "Pharma" : "Non-Pharma"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.type}</td>
                ...
                <td className="py-4 px-3 border border-slate-200 text-right font-bold text-slate-900 whitespace-nowrap">{fmt(r.totalPPAmount)}</td>
