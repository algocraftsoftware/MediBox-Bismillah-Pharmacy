...
export const MediboxInvoiceListView: React.FC<{ dueOnly?: boolean; heightClassName?: string }> = ({
  dueOnly = false,
        ...
        <table className="w-full text-left border-collapse text-sm border border-slate-300">
          <thead>
            <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Invoice No</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Invoice Date</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Customer ID</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Customer Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Customer Type</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Contact No</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">EID/PF No</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Organization</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Doctor Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Doctor Address</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Self/HD</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Remarks</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Store</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">User</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[5%] whitespace-nowrap">Discount</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[5%] whitespace-nowrap">Discount(%)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[5%] whitespace-nowrap">Paid Amt.</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[5%] whitespace-nowrap">Due Amt.</th>
          ...
          <tbody className="font-medium whitespace-nowrap">
            {rows.map((s) => (
              <tr key={s.id} className="odd:bg-white even:bg-slate-50 hover:bg-emerald-50/50">
                <td className="py-4 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{s.invoiceNo}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{new Date(s.createdAt).toLocaleString()}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.customer?.customerCode || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-900 font-bold whitespace-nowrap">{s.customer?.name || "Walk-in"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.customer?.custType || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.customer?.mobile || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.customer?.employeeId || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.customer?.orgName || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.doctorName || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.doctorAddress || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.deliveryMode === "DELIVERY" ? "HD" : "Self"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.remarks || "—"}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.store?.name}</td>
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{s.cashier?.name}</td>
                <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{s.discAmt.toFixed(2)}</td>
                <td className="py-4 px-3 border border-slate-200 text-right whitespace-nowrap">{s.discPct.toFixed(2)}</td>
                <td className="py-4 px-3 border border-slate-200 text-right font-bold text-slate-900 whitespace-nowrap">{s.paidAmount.toFixed(2)}</td>
                <td className={`py-4 px-3 border border-slate-200 text-right font-bold whitespace-nowrap ${s.dueAmount > 0.01 ? "text-red-600" : "text-slate-400"}`}>
