...
import { AddCustomerModal } from "../MediboxCustomerRegistrationView";
...
export const MediboxBillingView: React.FC = () => {
      ...
      <div className="bg-white border-b border-slate-300 p-3 shadow-sm">
        <div className="grid grid-cols-12 gap-2.5 items-center text-xs">
          ...
          <div className="col-span-3 flex items-center gap-1.5">
            ...
            <div className="flex-1 bg-slate-100 border border-slate-300 rounded px-2.5 py-1 font-bold text-slate-900 whitespace-nowrap">
              {custTypeLabel}
            </div>
          </div>
        ...
        <div className="flex items-center gap-4 flex-1">
          <div ref={itemSearchContainerRef} className="flex-1 max-w-2xl relative">
            ...
            {itemDropdownOpen && results.length > 0 && !selectedBatch && (
              <div className="absolute left-0 top-full mt-1 w-180 bg-white border border-slate-300 rounded shadow-xl z-40 max-h-72 overflow-auto">
                <table className="w-full text-left border-collapse text-sm border border-slate-300">
                  <thead>
                    <tr className="bg-slate-100 text-slate-600 font-bold uppercase sticky top-0">
                      <th className="py-4 px-2.5 border border-slate-300 w-[18%] whitespace-nowrap">Item Name</th>
                      <th className="py-4 px-2.5 border border-slate-300 w-[17%] whitespace-nowrap">Generic Name</th>
                      <th className="py-4 px-2.5 border border-slate-300 w-[16%] whitespace-nowrap">Category Name</th>
                      <th className="py-4 px-2.5 border border-slate-300 w-[14%] whitespace-nowrap">Supplier</th>
                      <th className="py-4 px-2.5 border border-slate-300 w-[10%] whitespace-nowrap">Batch</th>
                      <th className="py-4 px-2.5 border border-slate-300 text-right w-[9%] whitespace-nowrap">Stock</th>
                      <th className="py-4 px-2.5 border border-slate-300 w-[10%] whitespace-nowrap">Exp.Date</th>
                      <th className="py-4 px-2.5 border border-slate-300 text-right w-[6%] whitespace-nowrap">MRP</th>
                    </tr>
                  </thead>
                  <tbody className="whitespace-nowrap">
                    {results.map((r, i) => (
                      ...
                      >
                        <td className="py-4 px-2.5 border border-slate-200 font-black text-slate-900 whitespace-nowrap">{r.productName}</td>
                        <td className="py-4 px-2.5 border border-slate-200 text-slate-500 font-semibold whitespace-nowrap">{r.genericName}</td>
                        <td className="py-4 px-2.5 border border-slate-200 text-slate-600 whitespace-nowrap">{r.displayCategory || "—"}</td>
                        <td className="py-4 px-2.5 border border-slate-200 text-slate-600 whitespace-nowrap max-w-30">{r.supplierName || "—"}</td>
                        <td className="py-4 px-2.5 border border-slate-200 font-bold text-slate-700 whitespace-nowrap">{r.batchNo || "—"}</td>
                        <td className="py-4 px-2.5 border border-slate-200 text-right font-bold whitespace-nowrap">{r.stockQty}</td>
                        <td className="py-4 px-2.5 border border-slate-200 text-slate-500 whitespace-nowrap">{r.expiryDate ? r.expiryDate.split("T")[0] : "—"}</td>
                        <td className="py-4 px-2.5 border border-slate-200 text-right font-bold whitespace-nowrap">{r.sellingPrice.toFixed(2)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <table className="w-full text-left border-collapse text-sm border border-slate-300">
            <thead>
              <tr className="bg-slate-200/90 text-slate-800 font-extrabold uppercase whitespace-nowrap">
                <th className="py-3.5 px-3 border border-slate-300 w-[9%] whitespace-nowrap">Item Name</th>
                <th className="py-3.5 px-2.5 border border-slate-300 w-[8%] whitespace-nowrap">Display Category</th>
                <th className="py-3.5 px-2.5 border border-slate-300 w-[6%] whitespace-nowrap">Supplier</th>
                <th className="py-3.5 px-2.5 border border-slate-300 w-[4%] whitespace-nowrap">UOM</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-right w-[5%] whitespace-nowrap">VAT</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-right w-[5%] whitespace-nowrap">VAT%</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-right w-[5%] whitespace-nowrap">Disc.</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-right w-[5%] whitespace-nowrap">Disc%</th>
                <th className="py-3.5 px-2.5 border border-slate-300 w-[5%] whitespace-nowrap">Batch</th>
                <th className="py-3.5 px-2.5 border border-slate-300 w-[6%] whitespace-nowrap">Exp. Date</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-center w-[5%] whitespace-nowrap">Stock</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-right w-[5%] whitespace-nowrap">MRP</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-center w-[6%] whitespace-nowrap">Item Qty.</th>
                <th className="py-3.5 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Total Amount</th>
                <th className="py-3.5 px-1.5 border border-slate-300 text-center w-[4%] whitespace-nowrap">FREE?</th>
                <th className="py-3.5 px-1.5 border border-slate-300 text-center w-[4%] whitespace-nowrap">Reward</th>
                <th className="py-3.5 px-1.5 border border-slate-300 text-center w-[4%] whitespace-nowrap">PRDM</th>
                <th className="py-3.5 px-2.5 border border-slate-300 text-center w-[7%] whitespace-nowrap"></th>
              </tr>
            </thead>
            <tbody className="font-semibold text-base whitespace-nowrap">
              {cart.map((item) => (
                <tr key={item.batchId} className="odd:bg-white even:bg-slate-50 hover:bg-emerald-50/50 transition-colors">
                  <td className="py-4 px-3 border border-slate-200 font-extrabold text-slate-900 whitespace-nowrap">{item.productName}</td>
                  <td
                    className="py-4 px-2.5 border border-slate-200 text-slate-700 whitespace-nowrap"
                    title={item.displayCategory || undefined}
                  >
                    {item.displayCategory || "—"}
                  </td>
                  <td className="py-4 px-2.5 border border-slate-200 text-slate-700 truncate max-w-[220px]">{item.supplierName || "—"}</td>
                  <td className="py-4 px-2.5 border border-slate-200 whitespace-nowrap">{item.uom}</td>
                  <td className="py-4 px-2.5 border border-slate-200 text-right whitespace-nowrap">{lineVatAmt(item).toFixed(2)}</td>
                  <td className="py-4 px-2.5 border border-slate-200 text-right whitespace-nowrap">{item.vatPct ? `${item.vatPct}%` : ""}</td>
                  <td className="py-4 px-2.5 border border-slate-200 text-right whitespace-nowrap">
                    {resolvedDiscAmt > 0 ? lineProportionalDiscAmt(item).toFixed(2) : ""}
                  </td>
                  <td className="py-4 px-2.5 border border-slate-200 text-right whitespace-nowrap">
                    {resolvedDiscAmt > 0 ? `${Number(overallDiscPctApplied.toFixed(2))}%` : ""}
                  </td>
                  <td className="py-4 px-2.5 border border-slate-200 font-bold whitespace-nowrap">{item.batchNo || "—"}</td>
                  <td className="py-4 px-2.5 border border-slate-200 text-slate-700 whitespace-nowrap">{item.expiryDate ? item.expiryDate.split("T")[0] : "—"}</td>
                  <td className="py-4 px-2.5 border border-slate-200 text-center font-extrabold text-slate-800 whitespace-nowrap">{item.stockQty}</td>
                  <td className="py-4 px-2.5 border border-slate-200 text-right font-bold whitespace-nowrap">{item.mrp.toFixed(2)}</td>
                  <td className="py-2 px-2.5 border border-slate-200 text-center whitespace-nowrap">
                    <input
                      type="number"
                      min="1"
                      step="1"
                  ...
                  <td className="py-4 px-3 border border-slate-200 text-right font-black text-slate-900 whitespace-nowrap">{lineTotal(item).toFixed(2)}</td>
                  <td className="py-4 px-1.5 border border-slate-200 text-center whitespace-nowrap">
                    {item.isFree ? <span className="inline-block w-2.5 h-2.5 rounded-full bg-red-600" /> : 0}
                  </td>
                  <td className="py-4 px-1.5 border border-slate-200 text-center whitespace-nowrap">0</td>
                  <td className="py-4 px-1.5 border border-slate-200 text-center whitespace-nowrap">
                    {item.isPrdm ? <span className="inline-block w-2.5 h-2.5 rounded-full bg-blue-600" /> : 0}
                  </td>
                  <td className="py-4 px-2.5 border border-slate-200 text-center whitespace-nowrap">
