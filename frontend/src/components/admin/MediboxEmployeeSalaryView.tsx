...
export const MediboxEmployeeSalaryView: React.FC = () => {
          ...
          <table className="w-full text-sm border border-slate-300">
            <thead>
              <tr className="bg-slate-200/90 text-slate-800 font-black uppercase whitespace-nowrap">
                <th className="px-4 py-4 border border-slate-300 w-[14%] whitespace-nowrap">Employee</th>
                <th className="px-4 py-4 border border-slate-300 w-[12%] whitespace-nowrap">Mobile</th>
                <th className="px-4 py-4 border border-slate-300 text-right w-[16%] whitespace-nowrap">Monthly Salary</th>
                <th className="px-4 py-4 border border-slate-300 text-right w-[16%] whitespace-nowrap">Given Amount</th>
                <th className="px-4 py-4 border border-slate-300 w-[10%] whitespace-nowrap">Status</th>
                <th className="px-4 py-4 border border-slate-300 w-[12%] whitespace-nowrap">Paid Date</th>
                <th className="px-4 py-4 border border-slate-300 text-right w-[20%] whitespace-nowrap">Action</th>
              </tr>
            </thead>
              ...
              {pageRows.map((r) => {
                ...
                return (
                  <tr key={r.employeeId} className="odd:bg-white even:bg-slate-50 hover:bg-slate-100">
                    <td className="px-4 py-4 border border-slate-200 font-bold text-slate-800 whitespace-nowrap">{r.employeeName}</td>
                    <td className="px-4 py-4 border border-slate-200 font-semibold text-slate-600 whitespace-nowrap">{r.mobile}</td>
                    <td className="px-4 py-4 border border-slate-200 font-bold text-slate-800 text-right whitespace-nowrap">৳{fmt(r.salary)}</td>
                    <td className="px-4 py-4 border border-slate-200 font-bold text-slate-800 text-right whitespace-nowrap">৳{fmt(r.amount)}</td>
                    <td className="px-4 py-4 border border-slate-200 whitespace-nowrap">
                      {isPaid ? (
                    ...
                    <td className="px-4 py-4 border border-slate-200 font-semibold text-slate-600 whitespace-nowrap">
