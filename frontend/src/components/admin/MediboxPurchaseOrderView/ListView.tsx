        ...
        <table className="w-full text-left border-collapse text-sm border border-slate-300">
          <thead>
            <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
              <th className="py-4 px-3 border border-slate-300 w-[7%] whitespace-nowrap">Order No.</th>
              <th className="py-4 px-3 border border-slate-300 w-[8%] whitespace-nowrap">Order Date</th>
              <th className="py-4 px-3 border border-slate-300 w-[7%] whitespace-nowrap">Store Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[11%] whitespace-nowrap">For Store Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[10%] whitespace-nowrap">Supplier Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Req.Mode</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Status</th>
              ...
              <th className="py-4 px-3 border border-slate-300 text-right w-[7%] whitespace-nowrap">Total Amt.</th>
              <th className="py-4 px-3 border border-slate-300 text-center w-[10%] whitespace-nowrap"></th>
            </tr>
          </thead>
          <tbody className="font-medium whitespace-nowrap">
            {rows.map((r) => (
              <tr key={r.id} className="odd:bg-white even:bg-slate-50 hover:bg-emerald-50/50">
                <td className="py-4 px-3 border border-slate-200 font-bold text-slate-900 whitespace-nowrap">{r.orderNo || "—"}</td>
                ...
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.deliverToStore?.name || r.deliverTo}</td>
                ...
                <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.finalApprovedBy?.name || "—"}</td>
