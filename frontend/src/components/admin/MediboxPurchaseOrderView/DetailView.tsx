    ...
    <div className="flex flex-col h-[calc(100vh-3.25rem)] bg-[#f8fafc] overflow-hidden">
        ...
        <table className="w-full text-left border-collapse text-sm border border-slate-300">
          <thead>
            <tr className="bg-slate-200/90 text-slate-800 font-bold uppercase whitespace-nowrap sticky top-0">
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Item Code</th>
              <th className="py-4 px-3 border border-slate-300 w-[6%] whitespace-nowrap">Item Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[8%] whitespace-nowrap">Generic Name</th>
              <th className="py-4 px-3 border border-slate-300 w-[4%] whitespace-nowrap">UOM</th>
              <th className="py-4 px-3 border border-slate-300 w-[5%] whitespace-nowrap">Remarks</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">Pack Size</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">ROL</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[4%] whitespace-nowrap">QOH</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[5%] whitespace-nowrap">Con(Pcs)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">Con(Pack)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[8%] whitespace-nowrap">Item Qty(Box)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[8%] whitespace-nowrap">Item Qty(Pcs)</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[6%] whitespace-nowrap">Unit Price</th>
              <th className="py-4 px-3 border border-slate-300 text-right w-[8%] whitespace-nowrap">Total Values</th>
            ...
            {gridRows.map((r) => {
              ...
              return (
                <tr key={r.productId} className={hasQty ? "bg-emerald-50/70" : "odd:bg-white even:bg-slate-50 hover:bg-slate-100"}>
                  <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.itemCode}</td>
                  ...
                  <td className="py-4 px-3 border border-slate-200 text-slate-600 whitespace-nowrap">{r.uom}</td>
                  ...
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{r.packSize}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{r.rol}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{r.qoh}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-500 whitespace-nowrap">{r.consumptionPieces}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-500 whitespace-nowrap">{r.consumptionBox.toFixed(1)}</td>
                  <td className="py-2 px-2 border border-slate-200 whitespace-nowrap">
                    <input
                      type="number"
                      min={0}
                  ...
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{fmt(r.ppPerPiece)}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right font-bold text-slate-900 whitespace-nowrap">{fmt(totalValue)}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{fmt(r.mrpPerPiece)}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{fmt(r.gp)}</td>
                  <td className="py-4 px-3 border border-slate-200 text-right text-slate-600 whitespace-nowrap">{r.gpPct.toFixed(2)}</td>
      ...
      <div className="bg-white border-t border-slate-300 p-3 shrink-0 text-xs flex items-start gap-4">
        ...
        <div className="flex flex-col justify-end gap-1.5 shrink-0">
          ...
          <UnapproveButton
            status={order?.status}
            label={`Purchase Order ${order?.orderNo}`}
            onUnapprove={() => api.unapprovePurchaseOrder(orderId)}
            onDone={(result) => {
              setOrder(result as typeof order);
              setNotice("Un-approved — this order is back to Pending.");
            }}
