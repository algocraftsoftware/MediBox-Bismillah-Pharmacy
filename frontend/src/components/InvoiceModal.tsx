      ...
      <style>{`
        @media print {
          ...
          /* A thermal head has no greyscale: it either burns a dot or it
             ...
             by), while only the font-black lines survived. Forcing solid
             black — and disabling the browser's own colour "adjustment" —
             makes every line print at full strength. The page stays 58mm;
             nothing here changes the receipt's size. */
          #printable-receipt, #printable-receipt * {
            color: #000 !important;
            -webkit-print-color-adjust: exact;
            print-color-adjust: exact;
          }
          /* The 9px fine print needs a heavier stroke to hold together at
             203dpi; 9.5px + 600 weight stays within the same paper width. */
          #printable-receipt .receipt-fineprint,
          #printable-receipt .receipt-fineprint * {
